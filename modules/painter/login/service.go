...
import (
	...
	painterAuth "github.com/caddyserver/caddy/v2/modules/painter/auth"
	"github.com/caddyserver/caddy/v2/modules/painter/login/frontend"
...
func NewUserService(db *gorm.DB, log *zap.Logger, dingToken string) *UserService {
	return &UserService{
		db:        db,
		zapLogger: log,
